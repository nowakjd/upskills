...
class SpeakerInputValidatorTest {
    ...
    void happyPath() {
        ...
        SpeakerInput input = new SpeakerInput("John", "Doe", "123456789",
    ...
    void noPhone() {
        // given
        SpeakerInputValidator underTest = new SpeakerInputValidator();
        SpeakerInput input = new SpeakerInput("John", "Doe", "",
                "john@email.com", "My bio");
    ...
    void firstNameEmpty(String firstName) {
        // given
        SpeakerInputValidator underTest = new SpeakerInputValidator();
        SpeakerInput input = new SpeakerInput(firstName, "Doe", "123456789",
                "john@email.com", "My bio");
    ...
    void lastNameEmpty(String lastName) {
        // given
        SpeakerInputValidator underTest = new SpeakerInputValidator();
        SpeakerInput input = new SpeakerInput("John", lastName, "123456789",
                "john@email.com", "My bio");
    ...
    void emailAndPhoneEmpty(String email, String phoneNumber) {
        // given
        SpeakerInputValidator underTest = new SpeakerInputValidator();
        SpeakerInput input = new SpeakerInput("John", "Doe", email, phoneNumber,
                "My bio");
    ...
    void firstNameAndLastNameAreEmpty(String firstName, String lastName) {
        // given
        SpeakerInputValidator underTest = new SpeakerInputValidator();
        SpeakerInput input = new SpeakerInput(firstName, lastName, "123456789",
                "john@email.com", "My bio");
